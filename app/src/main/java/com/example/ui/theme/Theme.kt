...
private val DarkColorScheme =
    darkColorScheme(
        ...
        background = DarkColorSchemeBackground,
        surface = DarkColorSchemeSurface,
        onPrimary = DarkColorSchemeOnPrimary,
...
private val LightColorScheme =
    lightColorScheme(
        ...
        tertiary = LightColorSchemeTertiary,
        background = LightColorSchemeBackground,
        surface = LightColorSchemeSurface,
        onPrimary = LightColorSchemeOnPrimary,
